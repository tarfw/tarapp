...
export default function PeopleScreen() {
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      >
        <Text className="text-lg font-semibold text-gray-900">People</Text>
      ...
      >
        <View className="mb-6">
          ...
          <Text className="text-gray-600 mt-1">Manage your team members here.</Text>
        </View>
        
        <TouchableOpacity className="bg-blue-600 rounded-lg p-4 mb-6">
          <Text className="text-white text-center font-semibold">+ Add Team Member</Text>
        </TouchableOpacity>

        <View className="bg-white rounded-lg border border-gray-200 p-4 mb-6">
          <Text className="text-lg font-semibold text-gray-900 mb-3">Team Members</Text>
        ...
        <View className="bg-white rounded-lg border border-gray-200 p-4">
          <Text className="text-lg font-semibold text-gray-900 mb-3">Invite Options</Text>
